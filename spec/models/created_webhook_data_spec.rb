...
# Unit tests for PolarRb::CreatedWebhookData
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe PolarRb::CreatedWebhookData do
  let(:instance) { PolarRb::CreatedWebhookData.new }

  describe 'test an instance of CreatedWebhookData' do
    it 'should create an instance of CreatedWebhookData' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(PolarRb::CreatedWebhookData)
    end
  end

...
# Unit tests for PolarRb::CircadianBedtime
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe PolarRb::CircadianBedtime do
  let(:instance) { PolarRb::CircadianBedtime.new }

  describe 'test an instance of CircadianBedtime' do
    it 'should create an instance of CircadianBedtime' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(PolarRb::CircadianBedtime)
    end
  end

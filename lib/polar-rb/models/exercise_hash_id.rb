  ...
  class ExerciseHashId
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `PolarRb::ExerciseHashId` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `PolarRb::ExerciseHashId`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          start_time_utc_offset == o.start_time_utc_offset &&
          duration == o.duration &&
          calories == o.calories &&
          distance == o.distance &&
          ...
          running_index == o.running_index &&
          heart_rate_zones == o.heart_rate_zones &&
          samples == o.samples &&
          training_load_pro == o.training_load_pro
    end
